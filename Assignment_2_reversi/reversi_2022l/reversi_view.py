            ...
            for i in range(2):
                ...
                if self.option_menus_vars[i].get() == self.interractivePlayerName:
                    ...
                    if i == 0:
                        ...
                        self.game.player1 = player_creator.create_player(player_class, self.game.player1_color, self.game.player2_color, self.boardSize)
    
                    else:
                        player_class = self.possiblePlayers[self.option_menus_vars[i].get()]
                        self.game.player2 = player_creator.create_player(player_class, self.game.player2_color, self.game.player1_color, self.boardSize)
